...
import {InsiderGovernanceFeeder} from "../src/InsiderGovernanceFeeder.sol";
...
contract DeployInsiderGovernanceTrapScript is Script {
    function run() external {
        ...
        InsiderGovernanceFeeder feeder =
            new InsiderGovernanceFeeder(msg.sender);
        ...
        InsiderGovernanceManipulationTrap trap =
            new InsiderGovernanceManipulationTrap();

        /* ---------------------------------------------------------- */
        /* Configure Trap                                             */
        /* ---------------------------------------------------------- */

        trap.setFeeder(address(feeder));
        ...
        console2.log("Feeder deployed at:", address(feeder));
